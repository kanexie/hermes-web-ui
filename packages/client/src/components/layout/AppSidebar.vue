      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('agent')" class="nav-group-items">
		 ...
		 <RouteLinkItem class="nav-item" :to="{ name: 'hermes.models' }" :active="selectedKey === 'hermes.models'">
          <button class="nav-item" :class="{ active: selectedKey === 'hermes.knowledgeBase' }" @click="handleNav('hermes.knowledgeBase')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="nav-item" :class="{ active: selectedKey === 'hermes.models' }" @click="handleNav('hermes.models')">            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
